...
class Heap {
    public:
        ...
        void runMain(JavaClass*);
        void pushFrame(Frame*);
        void popFrame();
        JavaClass* getClass(std::string);
        void loadClass(JavaClass*);
        Frame* frameTop();
    ...
    private:
        ...
        std::unordered_map<std::string, JavaClass*>         _loadedClasses;         //!< Armazena as classes carregadas.
